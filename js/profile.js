...
const parkingHistory = [
   {
    id: 1,
    location: { lat: 12.9165, lng: 79.1325 },  // Approximate for BTC Parking Center Vellore
    address: "BTC Parking Center, Vellore",
    date: "2024-02-15",
    duration: "4 hours",
    cost: "$12.00"
},
{
    id: 2,
    location: { lat: 12.9200, lng: 79.1380 },  // Approximate for BNS Parking Vellore
    address: "BNS Parking, Vellore",
    date: "2024-02-10",
    duration: "2 hours",
    cost: "$6.00"
}
...
function initHistoryMap() {
    // Add Leaflet map
   const map = L.map('history-map').setView([12.9165, 79.1325], 13);
