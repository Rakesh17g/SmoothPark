...
const mockBookings = {
    active: [
        {
            id: 1,
            spaceName: "BNS Parking",
            address: "Parking lot no-1,RB nagar,chitoor bus stand,vellore ",
    ...
    upcoming: [
        {
            id: 2,
            spaceName: "Sri chelliamman parking center",
            address: "Near new busstand next to chelliamman temple,katpadi,vellore",
    ...
    past: [
        {
            id: 3,
            spaceName: "BTC parking",
            address: "Parking lot.W4RQ+V35, national highway 234,vellore",
